...
import { isDatabaseUnavailableError, queueLocalLeadSubmission } from "./_core/localLeadQueue";
  ...
  submit: publicProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      try {
        ...
        console.warn(`[Lead] Database unavailable; queued submission locally at ${queued.path}`);

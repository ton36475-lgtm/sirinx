/* eslint-disable */
// Generated by Wrangler by running `wrangler types functions/worker-configuration.d.ts` (hash: 585aa214672a5dba8134067e15d4edba)
// Runtime types generated with workerd@1.20260520.1 2026-05-21 nodejs_compat
interface __BaseEnv_Env {
	SIRINX_API_HOSTING_STRATEGY: "node-backend-proxy";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SIRINX_API_HOSTING_STRATEGY">> {}
}

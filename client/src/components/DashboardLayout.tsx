...
import { LayoutDashboard, Users, FileText, Inbox, ArrowLeft, LogOut, PanelLeft, Zap, BarChart3, Activity, ReceiptText } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ReceiptText, label: "Quotations", path: "/admin/quotations" },
